...
import { defaults } from 'reedkalisz-shared/fields/products.js';

import PAR from './data/PAR.js';
import PARStocks from './data/PARStocks.js';
...
class PARAPI extends ExternalAPI {
...
export default { PARAPI: new PARAPI() };
